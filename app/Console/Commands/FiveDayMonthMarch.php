...
class FiveDayMonthMarch extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'task:fiveDayMonthMarch';
     ...
     * @var string
     */
    protected $description = 'Create Tasks five day of March';
    ...
    {
        $task = Task::where('status','=','Active')->where('type','=','fiveDayMonthMarch')->get();
